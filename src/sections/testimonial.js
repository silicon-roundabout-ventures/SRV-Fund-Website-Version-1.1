...
import Franco from "assets/testimonial/sample.jpeg";
      ...
      >
        <Box sx={{ margingLeft: "40px", margingRight: "40px" }}>
          ...
          >
            ...
            >
              Entrepreneurship is at the core of our community
            </Text>
            <Text
              as="p"
              sx={{
          ...
          <Flex sx={styles.workflow.column}>
            <Box as="div" sx={styles.workflow.box}>
              <Box sx={styles.workflow.box.testimonial}>
                <Text as="p" sx={styles.workflow.box.text}>
                  Entrepreneurship is at the core of our community Entrp are at
                  the core of our community Entrepreneurship are at the core of
                  our community
                </Text>
            ...
            <Box as="div" sx={styles.workflow.box}>
              ...
              <Box sx={styles.workflow.box.testimonial}>
                <Text as="p" sx={styles.workflow.box.text}>
                  Entrepreneurship are at the core of our community Entrp are at
                  the core of our community Entrepreneurship are at the core of
                  our community
                </Text>
                <Box sx={styles.workflow.box.namebox}>
