        ...
        <Flex sx={styles.workflow.row}>
          <Box sx={{position: 'relative !important', marginLeft: '33.33333333%', flex: '0 0 auto', width: '33.3333333%',
            ...
            <Text as= 'p' sx={{
                    ...
                    Many of the world’s fastest-growing startups have used FI to raise funding, building a co-founding team, get into seed-accelerators, generate traction, recruit a team, and more.
            </Text>
            <Text as= 'p' sx={{
                        fontSize: '18px',
                        fontWeight: 'regular',
                ...
                The Founder Institute is designed to help founders and teams at the pre-seed stage.
              </Text>
          </Box>
        </Flex>
      </Container>
